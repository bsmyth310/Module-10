...
//Gives user choices and asks more questions based on choice. Or exits and generates html
...
//Prompts the user with Engineer questions, then generates the Engineer and pushes it to a team
...
//Prompts the user with intern questions, then generates the intern and pushes it to a team
...
//Handles our html generation
function generateHTML(team){
    const html = writeHTML(team)
    writeToFile("./dist/index.html", html)
}

//Returns html fram using buildCards as the helper function
...
<html lang="en">
    ...
    <body class="bg-primary">
        <div class="d-flex flex-column align-items-center" style="position:relative; min-height:100vh; padding-bottom: 10vh;">
            ...
            <a href="https://github.com/bsmyth310" target="_blank" class="list-group-item"><i class="fa-brands fa-github" style="font-size:8vh;" ></i></a>
            </footer>
        </div>
    </body>
</html>
...
//Builds our team cards with html
